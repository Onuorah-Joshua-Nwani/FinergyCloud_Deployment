...
export default function MobileBreadcrumb({ 
  ...
  const isWebsiteDemo = urlParams.get('demo') === 'true';
  
  // IMPORTANT: Hide mobile breadcrumb completely for website demo users
  // Only show for actual mobile app users (platform=mobile without demo=true)
  if (!isMobileApp || isWebsiteDemo) {
    return null;
  }

  return (
    <div className={`mb-4 ${className}`}>
      {/* Back Button - Only for actual mobile app users */}
      {showBackButton && (
        <div className="mb-3">
