                        ...
                        <div className="mt-4">
                          ...
                          <div className="space-y-1">
                            <Link href="/?platform=web">
                              <span className="nav-item block px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 cursor-pointer text-gray-600 hover:text-primary hover:bg-gray-50 mobile-menu-item text-base py-3 border-b border-gray-100">
                                <Info className="w-5 h-5 mr-3 flex-shrink-0" />
                                FinergyCloud Website
                              </span>
                            </Link>
                          </div>
                        </div>
