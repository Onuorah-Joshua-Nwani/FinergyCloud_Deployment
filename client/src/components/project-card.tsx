...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Card className="hover:shadow-lg transition-shadow border hover:border-primary/30">
      <CardContent className="p-4">
        ...
        <div className="grid grid-cols-3 gap-4 text-sm">
          <div>
            ...
            <p className="font-medium text-success">{project.irr}%</p>
          </div>
          <div>
            <p className="text-gray-500">ESG Score</p>
            <p className="font-medium text-gray-900">{project.esgScore}</p>
          </div>
          <div>
